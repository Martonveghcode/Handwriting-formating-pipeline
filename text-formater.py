...
def format_text(input_text, min_words=7, max_words=10, target_width=54, tolerance=4):
...
def on_format():
    ...
    formatted = format_text(processed_text)
    ...
    status_var.set("Formatted text with replacement mapping")
